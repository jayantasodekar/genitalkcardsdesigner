    ...
    PropertySheetCategory.prototype.render = function (container, context, displayCategoryName) {
        ...
        if (entriesToRender.length > 0) {
            if (displayCategoryName) {
                var header = new GenietalkCards.TextBlock();
...
var SubPropertySheetEntry = /** @class */ (function () {
    ...
    SubPropertySheetEntry.prototype.render = function (context) {
        var container = new GenietalkCards.Container();
...
var SingleInputPropertyEditor = /** @class */ (function (_super) {
    ...
    SingleInputPropertyEditor.prototype.render = function (context) {
        var _this = this;
        var leftColumn = new GenietalkCards.Column();
        ...
        if (additionalCommands && additionalCommands.length > 0) {
            var commandColumn = new GenietalkCards.Column();
            ...
            var actionSet = new GenietalkCards.ActionSet();
            var _loop_1 = function (command) {
                var action = new GenietalkCards.SubmitAction();
...
var StringPropertyEditor = /** @class */ (function (_super) {
    ...
    StringPropertyEditor.prototype.createInput = function (context) {
        var input = new GenietalkCards.TextInput();
...
var NumberPropertyEditor = /** @class */ (function (_super) {
    ...
    NumberPropertyEditor.prototype.createInput = function (context) {
        var input = new GenietalkCards.NumberInput();
        input.defaultValue = this.getPropertyValue(context);
        input.placeholder = "(not set)";
        return input;
    };
...
var BooleanPropertyEditor = /** @class */ (function (_super) {
    ...
    BooleanPropertyEditor.prototype.createInput = function (context) {
        var input = new GenietalkCards.ToggleInput();
        input.defaultValue = this.getPropertyValue(context);
        return input;
    };
...
var ChoicePropertyEditor = /** @class */ (function (_super) {
    ...
    ChoicePropertyEditor.prototype.createInput = function (context) {
        var input = new GenietalkCards.ChoiceSetInput();
        input.defaultValue = this.getPropertyValue(context);
...
var ActionPropertyEditor = /** @class */ (function (_super) {
    ...
    ActionPropertyEditor.prototype.createInput = function (context) {
        ...
        for (var i = 0; i < context.designContext.hostContainer.actionsRegistry.getItemCount(); i++) {
            ...
            if (doAddActionType) {
                var choice = new GenietalkCards.Choice(actionType, actionType);
...
var NameValuePairPropertyEditor = /** @class */ (function (_super) {
    ...
    NameValuePairPropertyEditor.prototype.render = function (context) {
        var _this = this;
        var result = new GenietalkCards.Container();
        ...
        if (nameValuePairs.length == 0) {
            var messageTextBlock = new GenietalkCards.TextBlock();
            ...
            var _loop_2 = function (i) {
                var textInput = new GenietalkCards.TextInput();
                ...
                var nameColumn = new GenietalkCards.Column("stretch");
                ...
                var valueColumn = new GenietalkCards.Column("stretch");
                valueColumn.spacing = GenietalkCards.Spacing.Small;
                valueColumn.addItem(textInput);
                var removeAction = new GenietalkCards.SubmitAction();
                ...
                var actionSet_1 = new GenietalkCards.ActionSet();
                actionSet_1.addAction(removeAction);
                var removeColumn = new GenietalkCards.Column("auto");
        ...
        var addAction = new GenietalkCards.SubmitAction();
...
var DesignerPeer = /** @class */ (function (_super) {
    ...
    DesignerPeer.prototype.buildPropertySheetCard = function (context) {
        var card = new GenietalkCards.GenietalkCard();
        card.padding = new GenietalkCards.PaddingDefinition(GenietalkCards.Spacing.Small, GenietalkCards.Spacing.Small, GenietalkCards.Spacing.Small, GenietalkCards.Spacing.Small);
        ...
        var _loop_3 = function (command) {
            if (command.showInPropertySheet) {
                var action_1 = new GenietalkCards.SubmitAction();
    ...
    DesignerPeer.idProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "id", "Id");
    return DesignerPeer;
...
var ActionPeer = /** @class */ (function (_super) {
    ...
    ActionPeer.titleProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "title", "Title");
    ActionPeer.styleProperty = new ChoicePropertyEditor(GenietalkCards.Versions.v1_2, "style", "Style", [
    ...
    ActionPeer.iconUrlProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_1, "iconUrl", "Icon URL");
    return ActionPeer;
}(DesignerPeer));
...
var HttpActionPeer = /** @class */ (function (_super) {
    ...
    HttpActionPeer.ignoreInputValidationProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_3, "ignoreInputValidation", "Ignore input validation");
    HttpActionPeer.methodProperty = new ChoicePropertyEditor(GenietalkCards.Versions.v1_0, "method", "Method", [
    ...
    HttpActionPeer.urlProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "url", "Url");
    HttpActionPeer.bodyProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "body", "Body", false, true);
    HttpActionPeer.headersProperty = new NameValuePairPropertyEditor(GenietalkCards.Versions.v1_0, "headers", "name", "value", function (name, value) { return new GenietalkCards.HttpHeader(name, value); }, "Name", "Value", "Add a new header", "This action has no header.");
...
var SubmitActionPeer = /** @class */ (function (_super) {
    ...
    SubmitActionPeer.ignoreInputValidationProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_3, "ignoreInputValidation", "Ignore input validation");
    SubmitActionPeer.dataProperty = new ObjectPropertyEditor(GenietalkCards.Versions.v1_0, "data", "Data");
...
var OpenUrlActionPeer = /** @class */ (function (_super) {
    ...
    OpenUrlActionPeer.urlProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "url", "Url");
...
var CardElementPeer = /** @class */ (function (_super) {
    ...
    CardElementPeer.idProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "id", "Id");
    CardElementPeer.isVisibleProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_2, "isVisible", "Initially visible");
    CardElementPeer.spacingProperty = new EnumPropertyEditor(GenietalkCards.Versions.v1_0, "spacing", "Spacing", GenietalkCards.Spacing);
    CardElementPeer.separatorProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_0, "separator", "Separator");
    CardElementPeer.horizontalAlignmentProperty = new EnumPropertyEditor(GenietalkCards.Versions.v1_0, "horizontalAlignment", "Horizontal alignment", GenietalkCards.HorizontalAlignment);
    CardElementPeer.heightProperty = new HeightPropertyEditor(GenietalkCards.Versions.v1_1, "height", "Height", [
...
var AdaptiveCardPeer = /** @class */ (function (_super) {
    ...
    AdaptiveCardPeer.prototype.populatePropertySheet = function (propertySheet, defaultCategory) {
        ...
        if (this.cardElement.selectAction) {
            ...
            propertySheet.add(PropertySheetCategory.SelectionAction, new SubPropertySheetEntry(GenietalkCards.Versions.v1_2, this.cardElement.selectAction, subPropertySheet));
        }
    };
    AdaptiveCardPeer.langProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_1, "lang", "Language");
    AdaptiveCardPeer.fallbackTextProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "fallbackText", "Fallback text", false, true);
    AdaptiveCardPeer.speakProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "speak", "Speak");
...
var ColumnPeer = /** @class */ (function (_super) {
    ...
    ColumnPeer.pixelWidthProperty = new SizeAndUnitPropertyEditor(GenietalkCards.Versions.v1_1, "width", "Width in pixels", GenietalkCards.SizeUnit.Pixel);
    ColumnPeer.weightProperty = new SizeAndUnitPropertyEditor(GenietalkCards.Versions.v1_0, "width", "Weight", GenietalkCards.SizeUnit.Weight);
    ColumnPeer.widthProperty = new ColumnWidthPropertyEditor(GenietalkCards.Versions.v1_0, "width", "Width", [
...
var ContainerPeer = /** @class */ (function (_super) {
    ...
    ContainerPeer.selectActionProperty = new ActionPropertyEditor(GenietalkCards.Versions.v1_0, "selectAction", "Action type", [GenietalkCards.ShowCardAction.JsonTypeName], true);
    ContainerPeer.minHeightProperty = new NumberPropertyEditor(GenietalkCards.Versions.v1_2, "minPixelHeight", "Minimum height in pixels");
    ContainerPeer.verticalContentAlignmentProperty = new EnumPropertyEditor(GenietalkCards.Versions.v1_1, "verticalContentAlignment", "Vertical content alignment", GenietalkCards.VerticalAlignment);
    ContainerPeer.styleProperty = new ContainerStylePropertyEditor(GenietalkCards.Versions.v1_0, "style", "Style");
    ContainerPeer.bleedProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_2, "bleed", "Bleed");
    ContainerPeer.backgroundImageProperty = new CompoundPropertyEditor(GenietalkCards.Versions.v1_0, "backgroundImage", [
...
var ImageSetPeer = /** @class */ (function (_super) {
    ...
    ImageSetPeer.prototype.internalAddCommands = function (context, commands) {
        ...
        commands.push(new peer_command_1.PeerCommand({
            ...
            isPromotable: true,
            execute: function (command, clickedElement) {
                var newImage = new GenietalkCards.Image();
    ...
    ImageSetPeer.ImageSizeProperty = new EnumPropertyEditor(GenietalkCards.Versions.v1_0, "imageSize", "Image size", GenietalkCards.Size);
    return ImageSetPeer;
}(TypedCardElementPeer));
...
var ImagePeer = /** @class */ (function (_super) {
    ...
    ImagePeer.urlProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "url", "Url", true);
    ImagePeer.altTextProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "altText", "Alternate text", true);
    ImagePeer.sizeProperty = new EnumPropertyEditor(GenietalkCards.Versions.v1_0, "size", "Size", GenietalkCards.Size);
    ImagePeer.pixelWidthProperty = new NumberPropertyEditor(GenietalkCards.Versions.v1_1, "pixelWidth", "Width in pixels");
    ImagePeer.pixelHeightProperty = new NumberPropertyEditor(GenietalkCards.Versions.v1_1, "pixelHeight", "Height in pixels");
    ImagePeer.styleProperty = new EnumPropertyEditor(GenietalkCards.Versions.v1_0, "style", "Style", GenietalkCards.ImageStyle);
    ImagePeer.backgroundColorProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_1, "backgroundColor", "Background color");
    return ImagePeer;
}(TypedCardElementPeer));
...
var MediaPeer = /** @class */ (function (_super) {
    ...
    MediaPeer.altTextProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_1, "altText", "Alternate text", true);
    MediaPeer.posterUrlProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_1, "posterUrl", "Poster URL", true);
    MediaPeer.sourcesProperty = new NameValuePairPropertyEditor(GenietalkCards.Versions.v1_1, "sources", "url", "mimeType", function (name, value) { return new GenietalkCards.MediaSource(name, value); }, "URL", "MIME type", "Add a new source", "No source has been defined.");
    return MediaPeer;
}(TypedCardElementPeer));
...
var FactSetPeer = /** @class */ (function (_super) {
    ...
    FactSetPeer.prototype.initializeCardElement = function () {
        ...
        this.cardElement.facts.push(new GenietalkCards.Fact("Fact 1", "Value 1"), new GenietalkCards.Fact("Fact 2", "Value 2"));
    };
    ...
    FactSetPeer.factsProperty = new NameValuePairPropertyEditor(GenietalkCards.Versions.v1_0, "facts", "name", "value", function (name, value) { return new GenietalkCards.Fact(name, value); }, "Name", "Value", "Add a new fact", "This FactSet is empty.");
    return FactSetPeer;
}(TypedCardElementPeer));
...
var InputPeer = /** @class */ (function (_super) {
    ...
    InputPeer.validationProperty = new CompoundPropertyEditor(GenietalkCards.Versions.v1_3, "validation", [
...
var TextInputPeer = /** @class */ (function (_super) {
    ...
    TextInputPeer.prototype.populatePropertySheet = function (propertySheet, defaultCategory) {
        ...
        if (this.cardElement.inlineAction) {
            ...
            propertySheet.add(PropertySheetCategory.InlineAction, new SubPropertySheetEntry(GenietalkCards.Versions.v1_2, this.cardElement.inlineAction, subPropertySheet));
        }
    ...
    TextInputPeer.defaultValueProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "defaultValue", "Default value");
    TextInputPeer.placeholderProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "placeholder", "Placeholder");
    TextInputPeer.isMultilineProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_0, "isMultiline", "Multi-line", true);
    TextInputPeer.styleProperty = new EnumPropertyEditor(GenietalkCards.Versions.v1_0, "style", "Style", GenietalkCards.InputTextStyle);
    TextInputPeer.maxLengthProperty = new NumberPropertyEditor(GenietalkCards.Versions.v1_0, "maxLength", "Maximum length");
    TextInputPeer.inlineActionProperty = new ActionPropertyEditor(GenietalkCards.Versions.v1_2, "inlineAction", "Action type", [GenietalkCards.ShowCardAction.JsonTypeName], true);
...
var NumberInputPeer = /** @class */ (function (_super) {
    ...
    NumberInputPeer.defaultValueProperty = new NumberPropertyEditor(GenietalkCards.Versions.v1_0, "defaultValue", "Default value");
    NumberInputPeer.placeholderProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "placeholder", "Placeholder");
    NumberInputPeer.minProperty = new NumberPropertyEditor(GenietalkCards.Versions.v1_0, "min", "Minimum value");
    NumberInputPeer.maxProperty = new NumberPropertyEditor(GenietalkCards.Versions.v1_0, "max", "Maximum value");
...
var DateInputPeer = /** @class */ (function (_super) {
    ...
    DateInputPeer.defaultValueProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "defaultValue", "Default value");
    DateInputPeer.minProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "min", "Minimum value");
    DateInputPeer.maxProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "max", "Maximum value");
...
var TimeInputPeer = /** @class */ (function (_super) {
    ...
    TimeInputPeer.defaultValueProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "defaultValue", "Default value");
    TimeInputPeer.minProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "min", "Minimum value");
    TimeInputPeer.maxProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "max", "Maximum value");
...
var ToggleInputPeer = /** @class */ (function (_super) {
    ...
    ToggleInputPeer.defaultValueProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "defaultValue", "Default value");
    ToggleInputPeer.titleProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "title", "Title", true);
    ToggleInputPeer.valueOnProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "valueOn", "Value when on");
    ToggleInputPeer.valueOffProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "valueOff", "Value when off");
    ToggleInputPeer.wrapProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_2, "wrap", "Wrap");
...
var ChoiceSetInputPeer = /** @class */ (function (_super) {
    ...
    ChoiceSetInputPeer.prototype.initializeCardElement = function () {
        this.cardElement.placeholder = "Placeholder text";
        this.cardElement.choices.push(new GenietalkCards.Choice("Choice 1", "Choice 1"), new GenietalkCards.Choice("Choice 2", "Choice 2"));
    };
    ChoiceSetInputPeer.defaultValueProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "defaultValue", "Default value");
    ChoiceSetInputPeer.placeholderProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "placeholder", "Placeholder");
    ChoiceSetInputPeer.isMultiselectProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_0, "isMultiSelect", "Allow multi selection");
    ChoiceSetInputPeer.isCompactProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_0, "isCompact", "Compact style");
    ChoiceSetInputPeer.wrapProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_2, "wrap", "Wrap");
    ChoiceSetInputPeer.choicesProperty = new NameValuePairPropertyEditor(GenietalkCards.Versions.v1_0, "choices", "title", "value", function (name, value) { return new GenietalkCards.Choice(name, value); }, "Title", "Value", "Add a new choice", "This ChoiceSet is empty");
...
var TextBlockPeer = /** @class */ (function (_super) {
    ...
    TextBlockPeer.textProperty = new StringPropertyEditor(GenietalkCards.Versions.v1_0, "text", "Text", true, true);
    TextBlockPeer.wrapProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_0, "wrap", "Wrap");
    TextBlockPeer.maxLinesProperty = new NumberPropertyEditor(GenietalkCards.Versions.v1_0, "maxLines", "Maximum lines", 0);
    TextBlockPeer.fontTypeProperty = new EnumPropertyEditor(GenietalkCards.Versions.v1_2, "fontType", "Font type", GenietalkCards.FontType);
    TextBlockPeer.sizeProperty = new EnumPropertyEditor(GenietalkCards.Versions.v1_0, "size", "Size", GenietalkCards.TextSize);
    TextBlockPeer.weightProperty = new EnumPropertyEditor(GenietalkCards.Versions.v1_0, "weight", "Weight", GenietalkCards.TextWeight);
    TextBlockPeer.colorProperty = new EnumPropertyEditor(GenietalkCards.Versions.v1_0, "color", "Color", GenietalkCards.TextColor);
    TextBlockPeer.subtleProperty = new BooleanPropertyEditor(GenietalkCards.Versions.v1_0, "subtle", "Subtle");
...
var RichTextBlockPeer = /** @class */ (function (_super) {
    ...
    RichTextBlockPeer.prototype.populatePropertySheet = function (propertySheet, defaultCategory) {
        ...
        propertySheet.add(defaultCategory, new CustomPropertySheetEntry("*", function (context) {
            var infoTextBlock = new GenietalkCards.TextBlock();
    ...
    RichTextBlockPeer.prototype.initializeCardElement = function () {
        var textRun = new GenietalkCards.TextRun();
