...
var CardDesigner = /** @class */ (function (_super) {
    ...
    function CardDesigner(hostContainers) {
        ...
        _this._targetVersion = GenietalkCards.Versions.latest;
        ...
        GenietalkCards.GenietalkCard.onProcessMarkdown = function (text, result) {
    ...
    CardDesigner.prototype.attachTo = function (root) {
        ...
        this._jsonEditorsPanel = new side_panel_1.SidePanel("jsonEditorPanel", side_panel_1.SidePanelAlignment.Bottom, document.getElementById("rightCollapsedPaneTabHost"));
